...
They calculate ![](https://latex.codecogs.com/svg.latex?\hat{A}=\tilde{D}^{-1/2}\tilde{A}\tilde{D}^{-1/2}) where ![](https://latex.codecogs.com/svg.latex?\tilde{D}) is the degree matrix of ![](https://latex.codecogs.com/svg.latex?\tilde{A}).

The forward model for calculating the representation of nodes is 
